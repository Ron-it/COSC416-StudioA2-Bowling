...
public class GameManager : MonoBehaviour
{
    ...
    private void SetPins()
    {
        ...
        //  We  first  make  sure  that  all  the  previous  pins  have  been  destroyed //  this  is  so  that  we  don't  create  a  new  collection  of
        ...
        //  We  add  the  Increment  Score  function  as  a  listener  to //  the  OnPinFall  event  each  of  new  pins
